	...
	<div class="post-inner flex-column">
		 ...
		 <a class="post-link" href="<?php the_permalink(); ?>">
			...
			<div class="post-content">
				<?php if ( 'post' === get_post_type() && cd_index_meta_date() ) : ?><div class="post-date"><?php echo get_the_date(); ?></div><?php endif; ?>
		...
		<div class="post-meta">
			<?php if ( 'post' === get_post_type() && cd_index_meta_cat() ) : ?><span class="post-category"><?php the_category( '/' ) ?></span><?php endif; ?>
