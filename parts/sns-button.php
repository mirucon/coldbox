    ...
    <ul class="share-list-container">
      ...
      <?php if ( function_exists( 'scc_get_share_hatebu' ) && cd_use_snsb_hatena() ): ?>
        <li class="hatena balloon-btn">
          <div class="share">
            <a class="share-inner" href="http://b.hatena.ne.jp/add?mode=confirm&url=<?php echo esc_url( $canonical_url_encode ); ?>&title=<?php echo esc_url( $title_encode );;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=510');return false;" target="_blank">
              <i class="icon-hatena"></i>
            </a>
          </div>
          <span class="count">
            <a class="count-inner" href="http://b.hatena.ne.jp/entry/<?php echo esc_url( $canonical_url_encode ); ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=510');return false;" target="_blank">
      ...
      <?php if ( function_exists( 'scc_get_share_facebook' ) && cd_use_snsb_facebook() ): ?>
        <li class="facebook balloon-btn">
          <div class="share">
            <a class="share-inner" href="http://www.facebook.com/sharer.php?src=bm&u=<?php echo esc_url( $canonical_url_encode );;?>&t=<?php echo esc_url( $title_encode );;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank">
              <i class="icon-facebook"></i>
            </a>
          </div>
          <span class="count">
            <a class="count-inner" href="http://www.facebook.com/sharer.php?src=bm&u=<?php echo esc_url( $canonical_url_encode );;?>&t=<?php echo esc_url( $title_encode );;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank">
      ...
      <?php if ( function_exists( 'scc_get_share_gplus' ) && cd_use_snsb_googleplus() ): ?>
        <li class="googleplus balloon-btn">
          <div class="share">
            <a class="share-inner" href="https://plus.google.com/share?url=<?php echo esc_url( $canonical_url_encode );;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=500');return false;" target="_blank">
              <i class="icon-googleplus"></i>
            </a>
          </div>
          <span class="count">
            <a class="count-inner" href="https://plus.google.com/share?url=<?php echo esc_url( $canonical_url_encode );;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=500');return false;" target="_blank">
