...
if ( !function_exists ( 'cd_customizer_style' ) ) {
  function cd_customizer_style() {
    ...
    if ( get_theme_mod( 'global_font_size_pc', '16' ) != '16' ) {
      ...
      $czr_font_size_pc = "
      body { font-size: ${font_size_pc}px; } ";
    ...
    if ( get_theme_mod( 'global_font_size_mobile', '16' ) != '16' ) {
      ...
      @media screen and ( max-width: 767px ) { body { font-size: ${font_size_mobile}px; } } ";
    ...
    if( get_theme_mod( 'header_color', '#ffffff' ) != '#ffffff' ) {
      ...
      $czr_color_header = "
      #header { background-color: $color_header; } ";
    ...
    if ( get_theme_mod( 'single_related_col', 2 ) != 2 ) {
      ...
      if ( $rel_col == 1 ) {
        $czr_rel_col = "
        .related-posts .related-article { width: 100%; } ";
      } else {
        $czr_rel_col = "
        .related-posts .related-article { width: calc(100% / $rel_col - 10px); } ";
      }
